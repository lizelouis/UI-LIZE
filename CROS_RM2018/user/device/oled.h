...
#define OLED_EA_Clr()  GPIO_ResetBits(GPIOE,GPIO_Pin_4)//EA
#define OLED_EA_Set()  GPIO_SetBits(GPIOE,GPIO_Pin_4)

#define OLED_CS_Clr()  GPIO_ResetBits(GPIOE,GPIO_Pin_6)//CS
#define OLED_CS_Set()  GPIO_SetBits(GPIOE,GPIO_Pin_6)
...
#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOA,GPIO_Pin_6)//DIN  D1
