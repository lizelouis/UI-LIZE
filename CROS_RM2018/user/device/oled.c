...
{ 	
 	...
 	RCC_APB1PeriphClockCmd(RCC_AHB1Periph_GPIOA|RCC_AHB1Periph_GPIOE|RCC_AHB1Periph_GPIOG, ENABLE);	 //使能PC,D,G端口时钟
...
//	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6;	 //PE4,PE6推挽输出  
// 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT; 		 //推挽输出
//	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
//	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
// 	GPIO_Init(GPIOE, &GPIO_InitStructure);	  
// 	GPIO_SetBits(GPIOE,GPIO_Pin_6);	//PE4,PE6 输出高
